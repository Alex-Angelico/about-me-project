...
// function quiz() {
//     var quizQuestions = [userNameEntry(), question1(), question2(), question3(), question4(), question5(), question6(), question7()];
//     for(var h = 0; h < quizQuestions.length; h++){
//         var functionCall = quizQuestions[h];
//         if (quizQuestions[h] === quizQuestions[0]) {
//             var quizUser = functionCall;
//         }
//     }
//     alert('Well, you ended up with ' + answerCount + '/7 points for the quiz, ' + quizUser + '. I hope you had fun! Now enjoy learning all about me on the page.');
// }

// function userNameEntry() {
//     var userName = prompt('Welcome to Alex\'s About Me page. What\'s your name?');
//     while (!userName) {
//         userName = prompt('Please enter a name so I know what to call you.');
//     }
//     alert('Hi ' + userName + '. Let\'s start off with a fun 5-question game of Y/N trivia--about yours truly, me!');
//     return userName;
// }
    ...
    for (var i = 0; i < chanceNumber; i++) {
        ...
        for (var j = 0; j < spaceShuttles.length; j++) {
            if (shuttleSelect === spaceShuttles[j]) {
                ...
                break;
            } else if ((shuttleSelect !== spaceShuttles[j] && j === (spaceShuttles.length - 1)) && i <= (chanceNumber - 2)) {
